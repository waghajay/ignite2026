      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              Empowering students to lead, innovate, and excel through impactful events and collaborative initiatives.
            </p>
            ...
            <div className="footer-social-icons">
              ...
              >
                <svg className="footer-social-svg" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://twitter.com/we_ignites"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
              >
              ...
              <a
                href="https://www.youtube.com/@ignite_sa"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
              >
              ...
              <a
                href="https://www.facebook.com/ignite.sa.mit"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
              >
          ...
          {/* Officials */}
          <div className="footer-section">
            <h4 className="footer-heading">Officials</h4>
            <ul className="footer-list">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-contact-list">
              <li className="footer-contact-item">
                ...
                <span>ignitestudentassociation@gmail.com</span>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+91 7387883221</span>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Maharashtra Institute of Technology, Chhatrapati Sambhajinagar, Maharashtra</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="footer-bottom-text">
            © 2026 IGNITE Student Association. All rights reserved.
          </p>
          <p className="footer-bottom-text">
            Made with <span className="footer-fire">FIRE</span> by IGNITE Team
          </p>
        </div>
      </div>
    </footer>
