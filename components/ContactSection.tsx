  ...
  return (
    <section className="py-16 px-4 bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          Have questions or want to join us? We're here to help!
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 rounded-full bg-yellow-500 flex-shrink-0 flex items-center justify-center">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 400 }}
                >
                  ESTD Department,Maharashtra Institute of Technology<br />
            ...
            <div className="flex gap-6 pt-8">
              ...
              >
                <svg className="w-7 h-7 text-yellow-500 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
