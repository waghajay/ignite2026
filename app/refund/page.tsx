      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed" style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 300 }}>
              For any inquiries regarding this policy or to discuss exceptional circumstances, please contact us at ignitestudentassociation@gmail.com or call +91 9420115023. Our team will respond within 2-3 business days.
            </p>
          </section>
        </div>
